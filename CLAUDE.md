...
| ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Starting a multi-step change, before the first edit                                 | `workspace-isolation`                                                             | Which branch or worktree the work lands in, and a clean baseline — without one, the first red run cannot be attributed   |
...
| Finishing a branch — merge, pull request, or leave it                               | `branch-completion`                                                               | The integration decision is the product owner's, and the cleanup step destroys work when it is guessed                   |
...
| Acting on review feedback, a bug report or a comment thread                         | `engineering-receiving-review`                                                    | An item that adds scope goes back through `/plan-gate`; agreeing before checking is the default failure mode             |
