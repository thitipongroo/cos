<#--
  ...
  mockup/mobile/02_shared/01_mfa/03_mfa_backup_codes_success &
  01_mfa/04_mfa_backup_codes_download — NOT the login page's chrome. Uses the mockup's own tokens
...
<head>
  ...
  <style>
    :root{
      /* mockup/mobile/02_shared/01_mfa/03_mfa_backup_codes_success tokens */
