<#--
  ...
  custom login.ftl) styled to match mockup/mobile/04_tenant_admin/07_mfa/01_mfa_enrollment
  for the parts Keycloak owns (PO decision: theme the Keycloak-owned parts exactly, omit the mockup's
  backup-codes bento / audit-trail / bottom-nav — those belong to the 07_mfa/03 recovery page, app/backend data,
