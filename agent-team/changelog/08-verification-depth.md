...
records it: suspect keys *"stayed ON HOLD for 6 runs because no rule checked the
reverse direction — items in report that shouldn't be there."*
...
*Prevents:* a check that passes because it was run shallowly.
