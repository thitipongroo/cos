...
`presentation.md` is one: a table mapping path → owner, the sentence *"Never edit
presentation HTML directly"*, the literal `Agent(...)` call, what to do when the
...
*Prevents:* a context file that grows until the important lines are buried.
