...
import {
  ...
  submitPoSignal,
  approvePoSignal,
} from '../../../src/modules/procurement/workflows/po.workflow';
import type { PoWorkflowParams } from '../../../src/modules/procurement/workflows/po.workflow';
...
describe('Phase 5 · PO approval threshold boundaries (master:1513-1518)', () => {
  ...
  beforeEach(async () => {
    ...
    worker = await Worker.create({
      ...
      taskQueue,
      workflowsPath: require.resolve('../../../src/modules/procurement/workflows/po.workflow'),
