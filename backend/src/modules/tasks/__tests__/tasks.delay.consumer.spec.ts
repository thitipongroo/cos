...
// §35.13 ESC-43: KafkaConsumer moved to @cos/kafka with ADR-055. Left pointing at @cos/shared,
// this factory intercepted nothing and every assertion below ran against a real Kafka client.
jest.mock('@cos/kafka', () => ({
