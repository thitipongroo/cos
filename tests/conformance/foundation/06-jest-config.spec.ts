...
const JEST_REQUIRED = [
  'backend',
  // ADR-055 (2026-08-22) moved every executable line out of @cos/shared and into @cos/kafka, so the
  // 100/100 gate moved with it. @cos/shared is listed under JEST_EXEMPT below for the same reason
  // @cos/types is: what remains is TypeScript types, which have nothing to execute.
  'packages/@cos/kafka',
...
const JEST_EXEMPT = ['packages/@cos/types', 'packages/@cos/shared'];
