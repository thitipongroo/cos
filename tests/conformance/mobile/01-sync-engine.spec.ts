...
// Sync priority on reconnect (master:3568) is asserted by
// apps/mobile/src/sync/__tests__/syncPriority.spec.ts — six cases against the same module,
// including the unranked tail and that every type the outbox can hold is ranked. This file
// IMPORTED that module, which made those unit tests living outside the app; they were removed on
// 2026-08-25 rather than kept in duplicate. The photo/media exclusion moved there with them.
