...
//
// MOVED 2026-08-29 from scripts/loadtest/api-baseline.js. That directory was folded into
// tests/load/ and deleted; three of its four scripts were merged into same-named files here, and
// this one had no counterpart to merge into — tests/load/api-baseline.js is the Phase 18 scenario
// (200 VU over 10 min, reads only, p95 < 1 s), a different profile for a different purpose. Renamed
// to qm6-baseline.js so the two are not mistaken for each other again (see §35.13 ESC-12).
//
// Run:
