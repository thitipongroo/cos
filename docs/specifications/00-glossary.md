...
| **IoT** (Internet of Things)            | อุปกรณ์เชื่อมต่ออินเทอร์เน็ต | Sensors and connected devices deployed on construction sites or in completed buildings. Post-MVP capability — Phase 24 (Digital Twin & IoT Layer); see `13-product-architecture` Layer 4 §13.5 and `33-digital-twin-iot`.                   |
