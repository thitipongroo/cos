...
| Project risk register                                   | Structured project risk log (distinct from AI delay-risk forecasting)              | **BUILT — ADR-065** (`ProjectRisk`, 4 endpoints, 2 events, AI-suggested feed, web heat map). Pulled forward from post-MVP by product-owner decision; ADR-065's follow-up list was stale and is corrected (TDD OQ-20, 2026-08-22) |
