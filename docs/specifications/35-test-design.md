...
| --- | --- | --- |
| `IMPLEMENTED` | 416 | A test file, script or configuration was observed on disk and is cited in the case row |
| `PLANNED` | 72 | The case is designed and derived from the spec, but no corresponding test asset was located |
