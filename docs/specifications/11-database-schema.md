...
7. Material — linked BOQ item's PO has at least one delivery record (corrected 2026-08-22: `deliveries` has no status column and none was ever declared; a row means goods were received, since delivered_at and received_by are both NOT NULL)
