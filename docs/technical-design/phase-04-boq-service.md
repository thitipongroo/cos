...
| #     | Question                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Status                     |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| OQ-23 | **A BOQ's total excludes every item that sits in a child category.** `recalculateVersionTotal` sums, over root categories only, the items attached **directly** to each root — child-category items are never added, and category subtotals are not rolled up into their parents. The phase command reads the same way literally ("`category.subtotal` = SUM(item.estimated_total) for all items in category" + "`version.total_estimated` = SUM(category.subtotal) for all root categories"), so the implementation is faithful to a rule that contradicts the hierarchy the schema provides. **Failure scenario:** a BOQ with root "Structural" and child "Concrete" holding 5,000,000 THB of items reports `total_estimated_amount = 0`. That total is what `version_approved` publishes and what Finance generates contracts against. Either subtotals roll up transitively, or items are constrained to root categories. | Open — needs a PO decision |
