...
- Rule 33, Rule 34 — `.claude/rules/rule-33-34-package-boundaries.md`; Rule 35 —
  `.claude/rules/rule-35-package-test-infra.md` (moved out of `context.md` 2026-09-02; long form in
