...
**Validated on this machine:** data-migration *mechanics* — schema / extension / hypertable+chunk /
...
load, which a dev volume cannot represent. A test machine proves *the procedure works*; staging
proves *it meets the SLO numbers*. Blue-green/canary + DR drills on production-representative data
