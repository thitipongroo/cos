...
| Android  | [`android/`](android/README.md) | ✅ 21 screens — cos_test emulator (Detox debug), live backend + seeded data |
| Web      | [`web/`](web/README.md)         | ✅ 24 screens — Chromium 1440×900, live backend + seeded data               |
