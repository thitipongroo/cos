...
**Do not reassign runtimes and do not split a module out of the monolith** unless *both* hold: a team
...
- **Rule 26 / 27 / 28** — add the dep to *that package's* `package.json`; add any new script to
