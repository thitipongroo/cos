...
No Quality Mandate and no Rule in `context.md` covers code review — checked against `context.md` and `context/00_master_construction_os.md`. The method above is the only written guidance in this repository.
