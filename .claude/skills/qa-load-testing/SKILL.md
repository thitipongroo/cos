...
The load profile is fixed: `tests/load/qm6-baseline.js`, 100 VU for 5 minutes. `tests/load/api-baseline.js` is a
different scenario (200 VU, reads only) and asserts none of the QM-6 budgets — the two were confused for each other
once, recorded as §35.13 ESC-12.
