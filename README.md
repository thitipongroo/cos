...
*Last updated: 2026-05-26 — Cloudflare WAF decision added to Phase 16; API path convention confirmed `/api/v1/` (NestJS `setGlobalPrefix('api/v1')` — source: `backend/src/main.ts`; C-04 resolved)*
