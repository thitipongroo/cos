...
// OIDC code exchange is in flight (Path B). Light theme per the §32.7 --mobile-* tokens; the shield +
...
const SHIELD_XML = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 3 4 6v6c0 5 3.5 7.5 8 9 4.5-1.5 8-4 8-9V6l-8-3Z" stroke="${colors.primary}" stroke-width="1.6" stroke-linejoin="round"/>
  <path d="m9 12 2 2 4-4" stroke="${colors.primary}" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
