// SyncPill — compact sync-status glyph for the Tenant Admin top bar (mockup 01_main's "SYNCED"
...
// NB: 01_main drew a gold "SYNCED", but gold is the SYNCING token (§6.1); synced is green (as
