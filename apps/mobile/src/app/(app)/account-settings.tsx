...
// Implements mockup/mobile/05_site_worker/05_profile/01_sw_account_settings.
//
...
// Settings + Logout) and `05_profile/01_sw_account_settings` is a full screen of its own.
//
