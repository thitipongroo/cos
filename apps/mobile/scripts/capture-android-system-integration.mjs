...
//   docs/screens/android/TENANT_ADMIN/09-system-integration.png
...
const OUT_DIR = resolve(HERE, '../../../docs/screens/android/TENANT_ADMIN');
const OUT = join(OUT_DIR, '09-system-integration.png');
