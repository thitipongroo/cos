...
// Logs in as the TENANT-ADMIN (+66811000002), opens the FAB's Quick Commands overlay → Invite New User,
...
const OTP_PHONE = process.env['E2E_OTP_PHONE'] ?? '0811000002'; // Suphaporn Rattanakul — TENANT-ADMIN
